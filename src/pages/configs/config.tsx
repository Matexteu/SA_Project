        ...
        <div className='flex-column items-center justify-center m-8'>
            <form className='flex-column'> 
                ...
                <div className='flex justify-between text-xl mb-2'>
                    ...
                    {(open === false) ? (
                            <div>
                                <select disabled value={(select === true) ? 'true' : 'false'} onChange={(e) => setSelect((e.target.value === 'true') ? true : false)}>
                         ...
                         : (
                            <div>
                                <select value={(select === true) ? 'true' : 'false'} onChange={(e) => setSelect((e.target.value === 'true') ? true : false)}>
                                    <option value='true'>Habilitado</option>
                                    <option value='false' >Desabilitado</option>
                                </select>
                            </div>
